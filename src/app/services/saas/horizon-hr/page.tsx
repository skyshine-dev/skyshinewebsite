...
export default function HorizonHRPage() {
  // Sample testimonials array for the slider
  const testimonialsData = [
    {
      quote: `"Horizon HR has revolutionized our HR operations. The AI-powered features have streamlined our entire workflow!"`,
      author: "Jennifer Chen",
      role: "HR Director, TechCorp",
    },
    {
      quote: `"Our HR efficiency increased by 50% after implementing Horizon HR. The automated processes are exceptional."`,
      author: "Michael Williams",
      role: "People Operations Lead, InnovateHR",
    },
    {
      quote: `"The analytics dashboard helps us make data-driven decisions. It's transformed how we manage our workforce."`,
      author: "Sarah Rodriguez",
      role: "HR Analytics Manager, FutureStaff",
    },
  ];
        ...
        <div className="container mx-auto px-6 relative flex flex-col md:flex-row items-start md:items-center gap-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300">
              Your AI-powered HR management platform for streamlined workforce operations,
              automated processes, and data-driven insights.
            </p>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-lg">
              Discover powerful capabilities that transform your HR operations with
            ...
            {[
              {
                ...
                desc: "AI-powered candidate screening and matching for efficient hiring."
              },
              {
                number: "02",
                title: "Automated Payroll",
                desc: "Streamlined payroll processing with automatic calculations and compliance."
              },
              {
                number: "03",
                title: "Performance Tracking",
                desc: "Real-time monitoring and evaluation of employee performance."
              },
              {
                number: "04",
                title: "Employee Engagement",
                desc: "Tools for measuring and improving workplace satisfaction."
              },
              {
                number: "05",
                title: "Training Management",
                desc: "Personalized learning paths and skill development tracking."
              },
              {
                number: "06",
                title: "HR Analytics",
                desc: "Advanced insights into workforce trends and metrics."
              }
            ].map((feat, i) => (
              <motion.div
                key={feat.number}
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-12">
            Experience Horizon HR&#39;s intuitive interfaces designed for modern HR management.
          </p>

          <div className="grid gap-8">
            {/* Top row: 2 bigger placeholders */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <PlaceholderBox label="HR Dashboard" extraClasses="h-72" icon="👥" />
              <PlaceholderBox label="Employee Management" extraClasses="h-72" icon="📋" />
            </div>

            {/* Bottom row: 3 smaller placeholders */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <PlaceholderBox label="Recruitment" extraClasses="h-48" icon="🎯" />
              <PlaceholderBox label="Analytics" extraClasses="h-48" icon="📊" />
              <PlaceholderBox label="Training" extraClasses="h-48" icon="🎓" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-center mb-10">
            Real feedback from organizations using Horizon HR to transform their HR operations.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-800 dark:text-white">
              Why Choose Horizon HR?
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Experience the benefits of AI-driven automation, analytics, and 
              intelligent insights—all in one powerful HR platform.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6 text-gray-700 dark:text-gray-200">
              <Bullet text="Streamlined HR operations through AI automation" />
              <Bullet text="Data-driven insights for strategic decisions" />
              <Bullet text="Enhanced employee experience and engagement" />
            </div>

            <div className="space-y-6 text-gray-700 dark:text-gray-200">
              <Bullet text="Seamless integration with existing systems" />
              <Bullet text="Comprehensive compliance and documentation" />
              <Bullet text="Scalable platform for growing organizations" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              Let Horizon HR help you streamline your workforce management with 
              our intelligent HR platform.
            </p>
            <button
