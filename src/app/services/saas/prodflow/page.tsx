...
export default function ProdflowPage() {
  // Sample testimonials array for the slider
  const testimonialsData = [
    {
      quote: `"ProdFlow has revolutionized our manufacturing process. The real-time tracking and automation features are game-changing!"`,
      author: "Michael Chen",
      role: "Operations Director, TechManufacture Inc",
    },
    {
      quote: `"Our production efficiency increased by 40% within months of implementing ProdFlow. The inventory management is exceptional."`,
      author: "Sarah Williams",
      role: "Plant Manager, InnovateProducts",
    },
    {
      quote: `"The quality control integration has reduced our defect rate significantly. ProdFlow is essential to our operations."`,
      author: "David Rodriguez",
      role: "Quality Assurance Lead, PrecisionMfg",
    },
  ];
        ...
        <div className="container mx-auto px-6 relative flex flex-col md:flex-row items-start md:items-center gap-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300">
              Your comprehensive manufacturing workload management system for optimized 
              operations, automated processes, and real-time production insights.
            </p>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-lg">
              Unlock powerful capabilities that streamline your manufacturing processes, 
              all with an intuitive system interface.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Real-time tracking and optimization of inventory levels with predictive analytics."
              },
              {
                number: "02",
                title: "Production Planning",
                desc: "Smart scheduling and resource allocation for maximum efficiency."
              },
              {
                number: "03",
                title: "Quality Assurance",
                desc: "Automated quality control processes with detailed reporting."
              },
              {
                number: "04",
                title: "Supply Chain Integration",
                desc: "Seamless connection with suppliers and logistics partners."
              },
              {
                number: "05",
                title: "Performance Tracking",
                desc: "Real-time monitoring of production metrics and KPIs."
              },
              {
                number: "06",
                title: "Maintenance Management",
                desc: "Predictive maintenance scheduling to prevent downtime."
              }
            ].map((feat, i) => (
              <motion.div
                key={feat.number}
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-12">
            Experience ProdFlow&#39;s intuitive interfaces designed for manufacturing excellence.
          </p>

          <div className="grid gap-8">
            {/* Top row: 2 bigger placeholders */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <PlaceholderBox label="Production Dashboard" extraClasses="h-72" icon="🏭" />
              <PlaceholderBox label="Inventory Management" extraClasses="h-72" icon="📦" />
            </div>

            {/* Bottom row: 3 smaller placeholders */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <PlaceholderBox label="Quality Control" extraClasses="h-48" icon="✓" />
              <PlaceholderBox label="Analytics Panel" extraClasses="h-48" icon="📊" />
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-center mb-10">
            Real feedback from businesses using ProdFlow to streamline their manufacturing operations.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Experience the benefits of AI-driven automation, analytics, and 
              intelligent insights—all in one powerful manufacturing platform.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6 text-gray-700 dark:text-gray-200">
              <Bullet text="Real-time production tracking and optimization" />
              <Bullet text="AI-powered inventory management and forecasting" />
              <Bullet text="Automated quality control and compliance" />
            </div>

            <div className="space-y-6 text-gray-700 dark:text-gray-200">
              <Bullet text="Seamless integration with existing systems" />
              <Bullet text="Scalable architecture for growing operations" />
              <Bullet text="Comprehensive analytics and reporting" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Book a demo to see how ProdFlow can transform your manufacturing operations
            </p>
            <Link
              href="/contact"
...
/* Reusable placeholder box for website examples */
